// qr-l3.js -- slide 41: continue to Lesson 3.
//
...
(function () {
  ...
  // art
  const img = L.el('image', { x: 40, y: 40, width: 260, height: 260, href: '../img/myth03.png' }, link);
  img.setAttributeNS(xlink, 'href', '../img/myth03.png');
  L.text(link, 'Lesson 3: Ship it', 170, 322, { size: 16, weight: 700 });
  // cliffhanger
  L.text(link, 'Continue to Lesson 3', 540, 44, { size: 26, weight: 700 });
  L.text(link, '“How do you choose the r-th legal move', 540, 80, { size: 15, fill: L.ORANGE, weight: 700, italic: true });
  L.text(link, 'without measuring the board?”', 540, 102, { size: 15, fill: L.ORANGE, weight: 700, italic: true });
  if (QR && QR.d) {
