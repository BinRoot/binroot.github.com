...
(function () {
  ...
  const D = window.L3, C = D.event.friends[D.focus], DIE = D.event.dice[D.focus];
  L.text(root, `round 2, cell 4: count = ${C}, die = ${DIE}, occupied`, 380, 30, { size: 14, weight: 700 });
  ...
  L.text(root, 'Each row expands into joint count + die control patterns.', 380, 272, { size: 13, fill: L.DIM });
  ...
  L.text(root, 'one output flag, reused', 631, 190, { size: 12, fill: L.DIM, italic: true });
