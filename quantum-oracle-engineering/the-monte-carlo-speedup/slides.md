...
1. step through choosing the first action
2. following a fixed policy for later actions
3. and recording whether the final state meets our objective
...
## The template for most problems {#sway}
